Use this jQuery plugin if wish to include a model as a nested attributes in a form as a group of inputs, and you want the user to select whether you wish to include a particular instance of that model, controlled with a checkbox.
